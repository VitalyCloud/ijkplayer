...
function sync_ff_version() {
    sed -i '' "s/static const char \*kIJKFFRequiredFFmpegVersion\ \=\ .*/static const char *kIJKFFRequiredFFmpegVersion = \"${IJK_FFMPEG_COMMIT}\";/g" $FF_PATH/IJKMediaPlayer/IJKMediaPlayer/IJKFFMoviePlayerController.m
}
